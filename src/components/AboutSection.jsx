    ...
    return (
        <SectionR id='about'>
            <SectionF>
                ...
                <h4 style={h4} id={props.id}>Frontend Developer based in Nigeria</h4>
                <p style={styleBody}>
                    I became a web developer because I'm drawn to a dynamic career 
                    that combines my spark for learning and helping others. <br /> <br />
                    ...
                    <br /> <br />
                    I constantly strive to be the best version of myself and to uplift everyone around me. 
                    I'm a fast learner and I love taking on challenges with creativity and hard work.
                </p>
                <br />
                    <Button>
